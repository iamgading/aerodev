...
export function Footer() {
  ...
  return (
    ...
    <Link
      href="/admin"
      className="fixed bottom-6 right-6 w-12 h-12 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-full flex items-center justify-center shadow-xl hover:scale-110 transition-all duration-300 opacity-20 hover:opacity-100 z-50"
      title="Admin Panel"
    >
