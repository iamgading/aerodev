...
import { getPostById, updatePost, uploadImage } from '@/lib/supabase/queries'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updatePost(params.id, {
        ...
        // Only update published_at if it was not published before and now is
        // But for simplicity, we might just leave it or update it if we want "re-publish" semantics
        // For now, let's not touch published_at unless we want to support scheduling or similar
      })
