...
import { getProjectById, updateProject, uploadImage } from '@/lib/supabase/queries'
...
export default function EditProjectPage({ params }: { params: { id: string } }) {
  ...
  const handleTitleChange = (title: string) => {
    // Only auto-generate slug if it hasn't been manually edited (simple heuristic: if it matches old title slug)
    // For simplicity in edit mode, we might just let user edit slug manually if they want, 
    // or auto-update it. Let's just update title and let user decide on slug.
    setFormData({
      ...formData,
      title,
      // slug: generateSlug(title), // Don't auto-update slug on edit to preserve URLs if needed
    })
  }
